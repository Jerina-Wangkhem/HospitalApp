        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BonudsSalary = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NurssingCharge = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_pescribedMedicines", x => x.id);
                    table.ForeignKey(
                        name: "FK_pescribedMedicines_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_pescribedMedicines_PatientReport_PatientReportId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicinesReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicinesReports_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicinesReports_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicinesReports_MedicineId",
                table: "MedicinesReports",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicinesReports_SupplierId",
                table: "MedicinesReports",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_pescribedMedicines_MedicineId",
                table: "pescribedMedicines",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_pescribedMedicines_PatientReportId",
                table: "pescribedMedicines",
